...
function Carouselcomp() {
    return (
        <>
            ...
            <Imports.Typography variant='caption' sx={{ display: { xs: 'none', sm:'none', md: 'none', lg:'block' }, color: 'red',
                        
                        position: 'absolute',
                      bottom: 0,
                       fontSize:{lg:'80px',md:'50px'}, color: 'white', paddingLeft:'450px'}}><strong>Food and Drink</strong></Imports.Typography>

                <Imports.Grid item xs={4} sx={{"&:hover img": {
                                opacity: 0.8
                              }}}>
                ...
                <Imports.Grid item xs={4} sx={{ padding: 0 , "&:hover img": {
                                opacity: 0.8
                              }}}>
